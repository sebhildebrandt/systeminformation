    ...
    process.nextTick(() => {
      util.nvidiaSmi().then((stdout, error) => {
        ...
        const results = gpus.map(gpu => {
          ...
          if (splittedData.length === 15) {
            return {
              driverVersion: splittedData[0],
              name: splittedData[1],
              pciBus: splittedData[2],
              fanSpeed: safeParseNumber(splittedData[3]),
              memoryTotal: safeParseNumber(splittedData[4]),
              memoryUsed: safeParseNumber(splittedData[5]),
              memoryFree: safeParseNumber(splittedData[6]),
              utilizationGpu: safeParseNumber(splittedData[7]),
              utilizationMemory: safeParseNumber(splittedData[8]),
              temperatureGpu: safeParseNumber(splittedData[9]),
              temperatureMemory: safeParseNumber(splittedData[10]),
              powerDraw: safeParseNumber(splittedData[11]),
              powerLimit: safeParseNumber(splittedData[12]),
              clockCore: safeParseNumber(splittedData[13]),
              clockMemory: safeParseNumber(splittedData[14]),
            }
          }
        });
