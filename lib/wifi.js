...
const { _linux, _darwin, _windows } = require('./common/consts');
...
function getVendor(model) {
  ...
  switch (true) {
    case modelName.indexOf('intel') >= 0:
      return 'Intel';
    case modelName.indexOf('realtek') >= 0:
      return 'Realtek';
    case modelName.indexOf('qualcom') >= 0:
      return 'Qualcom';
    case modelName.indexOf('broadcom') >= 0:
      return 'Broadcom';
    case modelName.indexOf('cavium') >= 0:
      return 'Cavium';
    case modelName.indexOf('cisco') >= 0:
      return 'Cisco';
    case modelName.indexOf('marvel') >= 0:
      return 'Marvel';
    case modelName.indexOf('zyxel') >= 0:
      return 'Zyxel';
    case modelName.indexOf('melanox') >= 0:
      return 'Melanox';
    case modelName.indexOf('d-link') >= 0:
      return 'D-Link';
    case modelName.indexOf('tp-link') >= 0:
      return 'TP-Link';
    case modelName.indexOf('asus') >= 0:
      return 'Asus';
    case modelName.indexOf('linksys') >= 0:
      return 'Linksys';
    default:
      return '';
  }
