...
function getVendor(model) {
  ...
  switch (true) {
    case modelName.startsWith('intel'):
      return 'Intel';
    case modelName.startsWith('realtek'):
      return 'Realtek';
    case modelName.startsWith('qualcom'):
      return 'Qualcom';
    case modelName.startsWith('broadcom'):
      return 'Broadcom';
    case modelName.startsWith('cavium'):
      return 'Cavium';
    case modelName.startsWith('cisco'):
      return 'Cisco';
    case modelName.startsWith('marvel'):
      return 'Marvel';
    case modelName.startsWith('zyxel'):
      return 'Zyxel';
    case modelName.startsWith('melanox'):
      return 'Melanox';
    case modelName.startsWith('d-link'):
      return 'D-Link';
    case modelName.startsWith('tp-link'):
      return 'TP-Link';
    case modelName.startsWith('asus'):
      return 'Asus';
    case modelName.startsWith('linksys'):
      return 'Linksys';
    default:
      return '';
  }
