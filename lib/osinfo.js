...
function getLogoFile(distro = '') {
  const distroName = distro.toLowerCase();
  switch (true) {
    case _windows:
      return 'windows';
    case distroName.indexOf('mac os') !== -1:
      return 'apple';
    case distroName.indexOf('arch') !== -1:
      return 'arch';
    case distroName.indexOf('centos') !== -1:
      return 'centos';
    case distroName.indexOf('coreos') !== -1:
      return 'coreos';
    case distroName.indexOf('debian') !== -1:
      return 'debian';
    case distroName.indexOf('deepin') !== -1:
      return 'deepin';
    case distroName.indexOf('elementary') !== -1:
      return 'elementary';
    case distroName.indexOf('fedora') !== -1:
      return 'fedora';
    case distroName.indexOf('gentoo') !== -1:
      return 'gentoo';
    case distroName.indexOf('mandriva') !== -1:
      return 'mandriva';
    case distroName.indexOf('manjaro') !== -1:
      return 'manjaro';
    case distroName.indexOf('mint') !== -1:
      return 'mint';
    case distroName.indexOf('mx') !== -1:
      return 'mx';
    case distroName.indexOf('openbsd') !== -1:
      return 'openbsd';
    case distroName.indexOf('freebsd') !== -1:
      return 'freebsd';
    case distroName.indexOf('opensuse') !== -1:
      return 'opensuse';
    case distroName.indexOf('puppy') !== -1:
      return 'puppy';
    case distroName.indexOf('raspbian') !== -1:
      return 'raspbian';
    case distroName.indexOf('reactos') !== -1:
      return 'reactos';
    case distroName.indexOf('redhat') !== -1:
      return 'redhat';
    case distroName.indexOf('slackware') !== -1:
      return 'slackware';
    case distroName.indexOf('sugar') !== -1:
      return 'sugar';
    case distroName.indexOf('steam') !== -1:
      return 'steam';
    case distroName.indexOf('suse') !== -1:
      return 'suse';
    case distroName.indexOf('mate') !== -1:
      return 'ubuntu-mate';
    case distroName.indexOf('lubuntu') !== -1:
      return 'lubuntu';
    case distroName.indexOf('xubuntu') !== -1:
      return 'xubuntu';
    case distroName.indexOf('ubuntu') !== -1:
      return 'ubuntu';
    case distroName.indexOf('solaris') !== -1:
      return 'solaris';
    case distroName.indexOf('tails') !== -1:
      return 'tails';
    case distroName.indexOf('feren') !== -1:
      return 'ferenos';
    case distroName.indexOf('robolinux') !== -1:
      return 'robolinux';
    case _linux && distroName:
      return distroName.toLowerCase().trim().replace(/\s+/g, '-');
    default:
      return _platform;
  }
}
